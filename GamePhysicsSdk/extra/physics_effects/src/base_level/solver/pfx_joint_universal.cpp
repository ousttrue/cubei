	...
	const PfxUniversalJointInitParam &param)
{
	...
	if(param.swing1LowerAngle > param.swing1UpperAngle || 
		!SCE_PFX_RANGE_CHECK(param.swing1LowerAngle,-SCE_PFX_PI-0.01f,SCE_PFX_PI+0.01f) || 
		!SCE_PFX_RANGE_CHECK(param.swing1UpperAngle,-SCE_PFX_PI-0.01f,SCE_PFX_PI+0.01f) || 
		param.swing2LowerAngle > param.swing2UpperAngle || 
		!SCE_PFX_RANGE_CHECK(param.swing2LowerAngle,-SCE_PFX_PI-0.01f,SCE_PFX_PI+0.01f) || 
		!SCE_PFX_RANGE_CHECK(param.swing2UpperAngle,-SCE_PFX_PI-0.01f,SCE_PFX_PI+0.01f)) {
