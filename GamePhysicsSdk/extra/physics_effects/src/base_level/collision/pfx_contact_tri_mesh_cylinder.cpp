...
bool pfxContactTriangleCylinder(PfxContactCache &contacts,PfxUInt32 facetId,
							...
							PfxUInt32 edgeChk,
							const PfxCylinder &cylinder,const PfxTransform3 &transformB)
{
	...
	PfxFloat distanceThreshold)
{
	...
	PfxVector3 half = absPerElem(transformB.getUpper3x3()) * PfxVector3(cylinderB.m_halfLen+cylinderB.m_radius);
	...
	PfxFloat distanceThreshold)
{
	...
	PfxUInt32 numSelFacets = pfxGatherFacets(meshA,
		...
		absPerElem(transformB.getUpper3x3()) * PfxVector3(cylinderB.m_halfLen+cylinderB.m_radius),selFacets);
	...
	PfxFloat distanceThreshold )
{
	...
	PfxVector3 _aabbB(cylinderB.m_halfLen,cylinderB.m_radius,cylinderB.m_radius);
