...
void createScenePrimitives()
{
	...
	// capsule
	{
		...
		PfxShape shape;
		shape.reset();
		shape.setOffsetOrientation(PfxQuat::rotationZ(0.5f*SCE_PFX_PI));
	...
	// convex mesh
	{
		...
		if(gConvex.m_numVerts > 0) {
			pfxReleaseConvexMesh(gConvex);
		}
...
void createSceneStacking1()
{
	createTowerCircle(PfxVector3(0.0f,0.0f,0.0f),8,24,PfxVector3(1));
}

void createSceneStacking2()
{
	createWall(PfxVector3(-12.0f,0.0f,0.0f),7,PfxVector3(0.5f));
	createWall(PfxVector3(-9.0f,0.0f,0.0f),7,PfxVector3(0.5f));
	createWall(PfxVector3(-6.0f,0.0f,0.0f),7,PfxVector3(0.5f));
	createWall(PfxVector3(-3.0f,0.0f,0.0f),7,PfxVector3(0.5f));
	createWall(PfxVector3( 0.0f,0.0f,0.0f),7,PfxVector3(0.5f));
	createWall(PfxVector3( 3.0f,0.0f,0.0f),7,PfxVector3(0.5f));
	createWall(PfxVector3( 6.0f,0.0f,0.0f),7,PfxVector3(0.5f));
	createWall(PfxVector3( 9.0f,0.0f,0.0f),7,PfxVector3(0.5f));
	createWall(PfxVector3( 12.0f,0.0f,0.0f),7,PfxVector3(0.5f));
...
void physicsCreateScene(int sceneId)
{
	...
	switch(sid) {
		...
		case 2: // stacking (tower)
		createSceneBoxGround();
		createSceneStacking1();
		break;

		case 3: // stacking (wall)
		createSceneBoxGround();
		createSceneStacking2();
		break;
