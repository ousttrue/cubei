...
static void createSceneBallJoint() {
  // 地面
  {
...
static void createSceneHingeJoint() {
...
static void createSceneFixedJoint() {
...
static int createGear(const EpxVector3 &offsetPosition,
