...
FontStashRenderer::FontStashRenderer(const char *name, const char *path) : fontNormal(FONS_INVALID) {
...
void FontStashRenderer::Draw(int width, int height, std::string_view title) {
  glEnable(GL_BLEND);
