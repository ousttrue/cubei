...
//--------------------------------------------------------------------------------------------------
q3HalfSpace::q3HalfSpace(const q3Vec3 &n, float d) : normal(n), distance(d) {}

//--------------------------------------------------------------------------------------------------
void q3HalfSpace::Set(const q3Vec3 &a, const q3Vec3 &b, const q3Vec3 &c) {
  normal = q3Cross(b - a, c - a).Normalized();
...
//--------------------------------------------------------------------------------------------------
const q3Vec3 q3HalfSpace::Origin() const { return normal * distance; }
